...
const Navbar = (props: Props) => {
    return (
        <nav className="sticky flex items-center justify-between bg-transparent pl-4 pt-[18px] pr-2 z-10">
            ...
            <div className="flex w-[48.5px] h-[48.5px]">
                <div className="bg-[#000818a6] flex h-full w-full relative rounded-xl justify-center items-center">
                    <button className="flex flex-col items-center justify-between w-[37.5px] h-[37.5px] px-2 py-[12.5px] bg-white rounded-lg">
                        <div className="w-4 h-0 border border-black"></div>
                        <div className="w-4 h-0 border border-black"></div>
                        <div className="w-4 h-0 border border-black"></div>
                    </button>
                </div>
