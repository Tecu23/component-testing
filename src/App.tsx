                        ...
                        <div className="flex flex-col items-center justify-center">
                            <div className="pb-[33px] relative w-[254px]">
                                ...
                                <p className="px-3 text-[13px] text-gray-300 font-semibold -tracking-wide leading-[18px] text-center pb-2">
                                    DeSo is the only blockchain that can power
                                    storage- heavy (infinite-state) applications
                                    by combining financial primitives with cheap
                                    content storage.
                                </p>
                            </div>
                    ...
                    <section className="relative">
                        <div className="flex flex-col items-center justify-center">
                                ...
                                <div className="w-[264px]">
                                    <div className="pb-[30px] mb-[30px] border-b border-gray-400">
                                        ...
                                        <p className="text-[12.5px] text-gray-300 font-medium -tracking-wide leading-[18px] text-left">
                                            ...
                                            storage-light (finite-state)
                                            applications, where data and storage
                                            stay constant with each transaction.
                                            With this approach for social, every
                                            interaction - post, like, follow,
                                            etc - wourld cost you $0.15+.
                                        </p>
                                    </div>
                                    <div className="mb-[11px]">
                                        ...
                                        <p className="text-[12.5px] text-gray-300 font-medium -tracking-wide leading-[18px] text-left">
                                            Infinite-state applications generate
                                            new data with every transaction that
                                            has to be stored and indexed. For
                                            example, social apps generate data
                                            with every post, like, follow, etc…
                                            DeSo is the only blockchain that can
                                            power next-gen applications like
                                            this.
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div className="mb-[125px] p-[25px] border border-gray-400 rounded-[15px] bg-[#000818a6] backdrop-blur-[12px]">
                                <div className="w-[264px]">
                                    <h4 className="mb-3 mr-[38px] text-[21px] font-medium text-white -tracking-wide font-victor-serif">
                                        Compare the costs of storing 200
                                        characters
                                        <i className="italic">
                                            {" (less than a tweet)"}
                                        </i>
